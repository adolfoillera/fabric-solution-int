...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "5a4d92e7-8a68-4a07-b4fa-1373ae872e40",
# META       "default_lakehouse_name": "lh_int_bronze",
# META       "default_lakehouse_workspace_id": "bdbdc00a-2375-4c45-87d2-be5387f0de47",
# META       "known_lakehouses": [
# META         {
# META           "id": "5a4d92e7-8a68-4a07-b4fa-1373ae872e40"
# META         }
# META       ]
# META     }
# META   }
...
# Defining some metadata for scalability For now, we will just use a Python object to store the metadata, but in later weeks, we will store this metadata (& add to it!)
...
def get_secret_from_akv()-> str: 
    ...
    akv_name= 'https://fcintdevtest.vault.azure.net/' 
    secret_name = 'AKVSecretRealProject'
...
def extract_uploads_playlist_id(channel_json_data):
    items = channel_json_data.get("items")

    if not items:
        raise ValueError("El JSON no contiene 'items' o está vacío")
    ...
    if not uploads_id:
        raise ValueError("No se encontró el uploads_id")
